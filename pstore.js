...
// Vinculación del botón de voz
  document.getElementById("btn-voz")?.addEventListener("click", activarBusquedaPorVoz);
...
function renderizarTarjetas(productos) {
  ...
  productos.forEach((prod, index) => {
    ...
    // Optimización LCP: Las primeras 2 tarjetas cargan de inmediato; el resto usa lazy loading
...
function toggleFavorito(id) {
  ...
  if (accion === "agregado") {
    ...
    registrarEvento("producto_favorito", String(id), nombreProd);
  }
}
